...
public class LinguaLeoTest1 extends TestBase {
    ...
    public void testLingvaleoRegister1() throws Exception {
        ...
        assertTrue(registrationpage.isElementPresent(By.cssSelector("div.dash-intro__greeting.clearfix")));
        assertTrue(registrationpage.isElementPresent(By.cssSelector("div.dash-intro__title")));
    }
